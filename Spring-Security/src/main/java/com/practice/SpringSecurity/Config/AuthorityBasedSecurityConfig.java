...
//@Configuration
//@EnableWebSecurity
//public class AuthorityBasedSecurityConfig {
//
//    /**
//     * custom authority based security configuration
//     */
//    @Bean
...
//                        .requestMatchers("/myAccount","/test-account").hasAuthority("VIEW_ACCOUNT")
//                        .requestMatchers("/myCards","/test-cards").hasAuthority("VIEW_CARDS")
//                        .requestMatchers("/myLoans","/test-loans").hasAuthority("VIEW_LOANS")
//                        .requestMatchers("/myBalance","/test-balance").hasAnyAuthority("VIEW_ACCOUNT","VIEW_BALANCE")
